...
2. **Reads base version** from `src/lib/LowlandTech.TinyTools.csproj` (e.g., `2026.1.3`)
3. **Derives final version** by replacing last segment: `2026.1.{BUILDR}`
   - Base: `2026.1.3` + BUILDR: `5` = **`2026.1.5`**
...
- **Base version in .csproj**: `2026.1.3` (major.minor.patch)
