...
public static class InterpolationExtensions
{
    ...
    public static string Interpolate(this string template, ToolContext context, ITemplateEngine? engine = null)
    {
        Guard.Against.NullOrEmpty(template, nameof(template), "Template should be supplied.");
    ...
    public static List<string> Interpolate(this List<string> templates, ToolContext context, ITemplateEngine? engine = null)
    {
