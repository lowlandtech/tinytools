...
public class ToolContext
{
    ...
    /// </summary>
    public ToolContext? Parent { get; private set; }
    ...
    /// </summary>
    public ToolContext CreateChild(string? key = null)
    {
        _logger.LogTrace("CreateChild('{Key}')", key);
        var child = new ToolContext(_logger)
        {
            Key = key,
            Parent = this
        };
    ...
    /// </summary>
    public void Merge(ToolContext other, params string[] keys)
    {
